...
export default class ModifyMarket extends React.Component {

    constructor(props) {
        super(props);
        this.state = {
            MarketName: props.Market.MarketName,
            Chart:props.Market.Chart,
            Units: props.Market.Units,
            OrderType:props.Market.OrderType,
            EntryPrice:props.Market.EntryPrice,
            StopLoss:props.Market.StopLoss,
            TakeProfit:props.Market.TakeProfit,
            CurrentPrice:props.Market.CurrentPrice,
            ProfitLoss:props.Market.ProfitLoss
        };
    }
          ...
          return(<form>
                    <div className="form-group">
                        ...
                        <input type="text" className="form-control" id="marketName" placeholder="Market Name"
                               disabled="true"  onChange={this.handleMarketNameChange.bind(this)} />
                    </div>
                    <div className="form-group">
