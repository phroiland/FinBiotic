...
class Account(object):
    ...
    def apply_trade_states(self, trade_states):
        ...
        Args:
            trade_states:
                A list of v20.trade.CalculatedTradeState objects
    ...
    def apply_position_states(self, position_states):
        ...
        Args:
            position_states:
                A list of v20.trade.CalculatedPositionState objects
    ...
    def apply_order_states(self, order_states):
        ...
        Args:
            order_states:
                A list of v20.order.DynamicOrderState objects
    ...
    def apply_state(self, state):
        ...
        Args:
            state:
                A v20.account.AccountState object representing changes to
